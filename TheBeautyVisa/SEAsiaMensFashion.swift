...
struct SEAsiaMensFashion: View {
  let fashionItems = [
    FashionItem(imageName: "seamen", description: ""),
    FashionItem(imageName: "seamen2", description: ""),
    FashionItem(imageName: "seamen4", description: ""),
    FashionItem(imageName: "seamen5", description: "")
  ]
  let columns = [
    GridItem(.flexible()),
    GridItem(.flexible())
